# Dracula for [mRemoteNG](https://mremoteng.org/)
...
This theme is maintained by the following person(s) and a bunch of [awesome contributors](https://github.com/dracula/mremoteng/graphs/contributors).
